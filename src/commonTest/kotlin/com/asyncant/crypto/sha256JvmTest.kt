...
class Sha256Test {
  ...
  fun testVectors() {
    ...
    assertEquals(emptyStringHash, Sha256.sha256(byteArrayOf()).toHexString())

    val abcHash = "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"
    assertEquals(abcHash, Sha256.sha256("abc".encodeToByteArray()).toHexString())

    val abc448BitsHash = "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1"
    assertEquals(
      abc448BitsHash,
      Sha256.sha256("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq".encodeToByteArray()).toHexString()
    )
    ...
    assertEquals(
      abc896BitsHash,
      Sha256.sha256(abc896Bits.encodeToByteArray()).toHexString()
    )

    val aOneMillionHash = "cdc76e5c9914fb9281a1c7e284d73e67f1809a48a497200e046d39ccc7112cd0"
    assertEquals(
      aOneMillionHash,
      Sha256.sha256("a".repeat(1000000).encodeToByteArray()).toHexString()
    )
  }
}
